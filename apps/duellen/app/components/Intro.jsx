    ...
    return (
      <div>
        ...
        <div class="row mb-3">
          <div class="col">
            <p>
              {this.state.sponsorText}
              <strong>{this.state.sponsor}</strong>
            </p>
          </div>
        </div>
        <MuiThemeProvider>
          <Button variant="contained" onClick={this.handleClick} class="start introBtn" fullWidth={true} primary={true}>
            {" "}
            Börja{" "}
          </Button>
        </MuiThemeProvider>
