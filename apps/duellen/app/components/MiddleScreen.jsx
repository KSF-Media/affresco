        ...
        <div>
          ...
          <div className="row mb-3">
            <div className="col-sm-6 text-center">
              ...
              <h4>
                {this.state.players.player1.name}
                <br /> fick {this.state.player1CurrentPoints} poäng på den här frågan
              </h4>
            </div>
            <div className="col-sm-6 text-center">
              <img src={this.state.players.player2.img} className="introImg"></img>
              <h4>
                {this.state.players.player2.name}
                <br /> fick {this.state.player2CurrentPoints} poäng på den här frågan
              </h4>
            </div>
          </div>
          <div className="row">
            <div className="col mt-3 text-center">
              <button onClick={() => this.props.onClick()} className="start introBtn">
