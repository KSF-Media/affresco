...
export const first = {
  ...
  question: 'En frukt',
  answer: 'Ananas',
  hint5: 'Tillhör släktet bär, fast klassad som frukt.',
  hint4: 'I det vilda kan denna frukt blomma i upp till 50 år.',
...
export const second = {
  category: 'Ekonomi:',
  question: 'Ett företag',
  answer: 'Google',
  hint5: 'Grundades av Larry Page och Sergei Brin.',
  hint4: 'Är störst på sitt område.',
...
export const third = {
  ...
  question: 'En insekt',
  answer: 'Älgfluga',
  hint5: 'Lipoptena cervi på latin.',
  hint4: 'Påträffades första gången i Finland 1960.',
...
export const fourth = {
  category: 'Litteratur:',
  question: 'En känd författare',
  answer: 'Lev Tolstoj',
  hint5: 'Levde åren 1828-1910.',
  hint4: 'Deltog i Krimkriget.',
...
export const fifth = {
  category: 'Konst:',
  question: 'En målare',
  answer: 'Albert Edelfelt',
  hint5: 'Finländare, levde åren 1854-1905.',
  hint4: 'Studerade i Antwerpen och i Paris.',
