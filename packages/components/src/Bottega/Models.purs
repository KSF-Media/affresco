...
import Bottega.Models.CreditCard (CreditCard, CreditCardId(..), CreditCardRegister, CreditCardRegisterNumber(..), CreditCardRegisterState(..), CreditCardRegisterStatus, RegisterCallback(..), parseCreditCardRegisterState) as Models
