...
exports.updateCreditCard_ = function (cusno, oldCreditCard, registerNumber, result) {
    dataLayer.push({ 'event': 'updateCreditCard', 'cusno': cusno, 'oldCreditCard': oldCreditCard, 'registerNumber': registerNumber, 'result': result })
}
