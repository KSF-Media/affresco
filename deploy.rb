...
apps_servers_json = ""
begin
  apps_json = run_command("npx dhall-to-json <<< \"./ci/apps.dhall\"")
  apps_servers_json = run_command("npx dhall-to-json <<< \"./ci/app-servers.dhall\"")
rescue Exception => e
...
puts "apps_servers_json: '#{apps_servers_json}'"
